...
export function Patients({
    ...
    const handleSave = () => {
        ...
        if (editingPatient) {
            router.post(
                `${baseUrl}/clientes/${editingPatient.id}`,
                {
                    _method: 'PUT',
                    ...data,
                },
                {
                    onSuccess: () => {
                        setPatients(
                            patients.map((p) => p.id === editingPatient.id ? {...p,...data,age: Number(formData.age)}: p,),);
                        setShowModal(false);
                    },
                },
            );
                        ...
                        <tbody className="divide-y divide-gray-100">
                            {filteredPatients.map((patient) => (
                                ...
                                >
                                    ...
                                    <td className="flex items-center gap-1 px-6 py-4 text-sm text-gray-500">
